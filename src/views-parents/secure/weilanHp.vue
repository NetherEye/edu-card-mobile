<template>
	<div class="pub">
		<van-nav-bar title="添加围栏" left-arrow @click-left="$router.go(-1)" fixed />
		...
		<div class="wrap">
			...
			<van-cell-group>
				<van-field label="围栏描述" :maxlength="20" v-model="form.fenceDescribe" placeholder="请输入" />
			</van-cell-group>
			...
			<div class="btn" @click="sub">确定添加</div>
		</div>
